...
var ListAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, admin_1.admin.find({}).select({ password: 0 })];
            case 1:
                result = _a.sent();
                if (result.length == 0)
                    return [2 /*return*/, (0, respJson_1.respJson)(res, 400, false, { msg: 'no hay datos' })];
                return [2 /*return*/, (0, respJson_1.respJson)(res, 200, true, { data: result })];
            case 2:
                error_1 = _a.sent();
