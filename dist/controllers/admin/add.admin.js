...
var AddAdmin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, password, name_1, ex, salt, hash, userDB, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                name_1 = String(req.body.name);
                return [4 /*yield*/, admin_1.admin.exists({ user: user, name: name_1 })];
            case 1:
                ex = _a.sent();
                if (ex)
                    return [2 /*return*/, (0, respJson_1.respJson)(res, 400, false, { msg: 'Usuario Existente' })];
                salt = bcrypt_1.default.genSaltSync(10);
                hash = bcrypt_1.default.hashSync(password, salt);
                return [4 /*yield*/, new admin_1.admin({ user: user, password: hash, name: name_1 }).save()];
            case 2:
                userDB = _a.sent();
                if (!userDB)
                    return [2 /*return*/, (0, respJson_1.respJson)(res, 400, false, { msg: '## Error al crear un usuario nuevo ##' })];
                console.log(cli_color_1.default.cyan('Exito al Cargar', userDB));
                return [2 /*return*/, (0, respJson_1.respJson)(res, 200, true, { data: 'Exito al Cargar', userDB: userDB })];
            case 3:
                error_1 = _a.sent();
