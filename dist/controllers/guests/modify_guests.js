...
var Modifyguests = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, invitados_1.inv.findOneAndUpdate({ codigo: codigo }, { estado: estado })];
            case 1:
                result = _b.sent();
                if (!result)
                ...
                return [2 /*return*/, (0, respJson_1.respJson)(res, 200, true, { msg: 'Estado del familiar actualizado exitosamente' })];
            case 2:
                error_1 = _b.sent();
