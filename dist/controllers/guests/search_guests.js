...
var SearchGuests = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var apellido, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                apellido = req.body.apellido;
                return [4 /*yield*/, invitados_1.inv.findOne({ apellido: apellido })];
            case 1:
                result = _a.sent();
                if (!result)
