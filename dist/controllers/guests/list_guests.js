...
var ListGuests = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, invitados_1.inv.find({})];
            case 1:
                result = _a.sent();
                if (result.length == 0)
                    return [2 /*return*/, (0, respJson_1.respJson)(res, 400, false, { msg: 'Error en la Consulta a la base de datos' })];
